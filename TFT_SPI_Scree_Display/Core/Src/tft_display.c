...
static const uint16_t font12x12[95][12] = {
    ...
    // ' (39)
	{0x180, 0x180, 0x300, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000}, // shifted
    // ( (40)
    ...
    // , (44)
	{0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x600, 0x600, 0xC00, 0x000, 0x000}, // shifted
    // - (45)
    {0x000, 0x000, 0x000, 0x000, 0x1FE, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000},
    // . (46)
	{0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x180, 0x180, 0x000, 0x000, 0x000},  // shifted
    // / (47)
    ...
    // 6 (54)
	{0x3F0, 0x618, 0xC00, 0xC00, 0xFF0, 0xC18, 0xC0C, 0x618, 0x3F0, 0x000, 0x000, 0x000}, // shiftef
    // 7 (55)
	// 7 (55) shifted left
	{0xFFC, 0x00C, 0x018, 0x030, 0x060, 0x0C0, 0x180, 0x300, 0x300, 0x000, 0x000, 0x000}, // shifted
    // 8 (56)
    ...
    // A (65)
	{0x060, 0x0F0, 0x198, 0x198, 0x30C, 0x3FC, 0x60C, 0x60C, 0x60C, 0x000, 0x000, 0x000}, // shifted
    // B (66)
	{0xFF0, 0xC18, 0xC18, 0xC18, 0xFF0, 0xC18, 0xC18, 0xC18, 0xFF0, 0x000, 0x000, 0x000}, // shifted
    // C (67)
	{0x3F0, 0x618, 0xC00, 0xC00, 0xC00, 0xC00, 0xC00, 0x618, 0x3F0, 0x000, 0x000, 0x000}, // shifted
    // D (68)
	{0xFE0, 0xC30, 0xC18, 0xC18, 0xC18, 0xC18, 0xC18, 0xC30, 0xFE0, 0x000, 0x000, 0x000}, // shifted
    // E (69)
	{0xFFC, 0xC00, 0xC00, 0xC00, 0xFF0, 0xC00, 0xC00, 0xC00, 0xFFC, 0x000, 0x000, 0x000}, // shifted
    // F (70)
	{0xFFC, 0xC00, 0xC00, 0xC00, 0xFF0, 0xC00, 0xC00, 0xC00, 0xC00, 0x000, 0x000, 0x000}, // shifted
    // G (71)
	{0x3F0, 0x618, 0xC00, 0xC00, 0xCFC, 0xC0C, 0xC0C, 0x618, 0x3F0, 0x000, 0x000, 0x000}, // shifted
    // H (72)
	{0xC18, 0xC18, 0xC18, 0xC18, 0xFFC, 0xC18, 0xC18, 0xC18, 0xC18, 0x000, 0x000, 0x000}, // shifted
    // I (73)
	{0x7F8, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x7F8, 0x000, 0x000, 0x000}, // shifted
    // J (74)
	{0x078, 0x018, 0x018, 0x018, 0x018, 0xC18, 0xC18, 0x618, 0x3F0, 0x000, 0x000, 0x000},  //shifted
    // K (75)
	{0xC18, 0xC30, 0xC60, 0xCC0, 0xF00, 0xCC0, 0xC60, 0xC30, 0xC18, 0x000, 0x000, 0x000}, // shifted
    // L (76)
	{0xC00, 0xC00, 0xC00, 0xC00, 0xC00, 0xC00, 0xC00, 0xC00, 0xFF0, 0x000, 0x000, 0x000}, // shifted
    // M (77)
	{0xC18, 0xE38, 0xFF8, 0xDD8, 0xCD8, 0xC18, 0xC18, 0xC18, 0xC18, 0x000, 0x000, 0x000}, // shifted
    // N (78)
	{0xC18, 0xE18, 0xF18, 0xCD8, 0xC6C, 0xC78, 0xC38, 0xC18, 0xC18, 0x000, 0x000, 0x000}, // shifted
    // O (79)
	{0x3F0, 0x618, 0xC0C, 0xC0C, 0xC0C, 0xC0C, 0xC0C, 0x618, 0x3F0, 0x000, 0x000, 0x000}, // shifted
    // P (80)
	{0xFF0, 0xC18, 0xC18, 0xC18, 0xFF0, 0xC00, 0xC00, 0xC00, 0xC00, 0x000, 0x000, 0x000}, // shifted
    // Q (81)
	{0x3F0, 0x618, 0xC0C, 0xC0C, 0xC0C, 0xCCC, 0xC6C, 0x618, 0x3FC, 0x00C, 0x000, 0x000}, // shifted
    // R (82)
	{0xFF0, 0xC18, 0xC18, 0xC18, 0xFF0, 0xC60, 0xC30, 0xC18, 0xC0C, 0x000, 0x000, 0x000}, //shifted
    // S (83)
	{0x3F0, 0x618, 0xC00, 0xC00, 0x3F0, 0x018, 0x018, 0x618, 0x3F0, 0x000, 0x000, 0x000}, // shifted
    // T (84)
	{0x7F8, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x000, 0x000, 0x000}, // shifted
    // U (85)
	{0xC18, 0xC18, 0xC18, 0xC18, 0xC18, 0xC18, 0xC18, 0x618, 0x3F0, 0x000, 0x000, 0x000}, // shifted
    // V (86)
	{0xC18, 0xC18, 0xC18, 0x618, 0x618, 0x330, 0x330, 0x1E0, 0x0C0, 0x000, 0x000, 0x000}, // shifted
    // W (87)
	{0xC18, 0xC18, 0xC18, 0xC18, 0xD98, 0xD98, 0xFF8, 0x630, 0x630, 0x000, 0x000, 0x000}, // shifted
    // X (88)
	{0xC18, 0xC18, 0x630, 0x330, 0x1E0, 0x1E0, 0x330, 0x630, 0xC18, 0x000, 0x000, 0x000}, // shifted
    // Y (89)
	{0x618, 0x618, 0x618, 0x330, 0x1E0, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x000, 0x000, 0x000}, // shifted
    // Z (90)
	{0x7F8, 0x018, 0x030, 0x060, 0x0C0, 0x180, 0x300, 0x600, 0x7F8, 0x000, 0x000, 0x000}, // shifted
    // [ (91)
    ...
    // a (97)
	{0x000, 0x000, 0x000, 0x7E0, 0x030, 0x7F0, 0xC30, 0xC30, 0x7F0, 0x000, 0x000, 0x000}, // shifted
    // b (98)
	{0xC00, 0xC00, 0xC00, 0xFF0, 0xC18, 0xC18, 0xC18, 0xC18, 0xFF0, 0x000, 0x000, 0x000}, // shifted
    // c (99)
	{0x000, 0x000, 0x000, 0x3F0, 0x618, 0xC00, 0xC00, 0x618, 0x3F0, 0x000, 0x000, 0x000}, //shifted
    // d (100)
	{0x018, 0x018, 0x018, 0x3F8, 0x618, 0xC18, 0xC18, 0x618, 0x3F8, 0x000, 0x000, 0x000}, // shifted
    // e (101)
	{0x000, 0x000, 0x000, 0x3F0, 0x618, 0xFFC, 0xC00, 0x618, 0x3F0, 0x000, 0x000, 0x000},  //shifted
    // f (102)
	{0x1E0, 0x330, 0x300, 0xFC0, 0x300, 0x300, 0x300, 0x300, 0x300, 0x000, 0x000, 0x000},  //shifted
    // g (103)
	{0x000, 0x000, 0x000, 0x3F8, 0x618, 0xC18, 0xC18, 0x618, 0x3F8, 0x018, 0x618, 0x3F0}, // shifted
    // h (104)
	{0x000, 0xC00, 0xC00, 0xC00, 0xFF0, 0xC18, 0xC18, 0xC18, 0xC18, 0x000, 0x000, 0x000},  // shifted
    // i (105)
	{0x180, 0x000, 0x000, 0x180, 0x180, 0x180, 0x180, 0x180, 0x180, 0x000, 0x000, 0x000},  //shifted
    // j (106)
	{0x0C0, 0x000, 0x000, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0x0C0, 0xCC0, 0x780}, // shifted
    // k (107)
	{0xC00, 0xC00, 0xC00, 0xC30, 0xC60, 0xCC0, 0xF80, 0xC60, 0xC30, 0x000, 0x000, 0x000}, // shifted
    // l (108)
	{0xC00, 0xC00, 0xC00, 0xC00, 0xC00, 0xC00, 0xC00, 0xC00, 0xC00, 0x000, 0x000, 0x000}, // shifted
    // m (109)
	{0x000, 0x000, 0x000, 0xFF0, 0xD98, 0xD98, 0xD98, 0xD98, 0xD98, 0x000, 0x000, 0x000}, // shifted
    // n (110)
	{0x000, 0x000, 0x000, 0x6E0, 0x730, 0x618, 0x618, 0x618, 0x618, 0x000, 0x000, 0x000}, // shifted
    // o (111)
	{0x000, 0x000, 0x000, 0x3F0, 0x618, 0xC18, 0xC18, 0x618, 0x3F0, 0x000, 0x000, 0x000}, // shifted
    // p (112)
	{0x000, 0x000, 0x000, 0xFF0, 0xC18, 0xC18, 0xC18, 0xC18, 0xFF0, 0xC00, 0xC00, 0xC00}, // shifted
    // q (113)
	{0x000, 0x000, 0x000, 0x3F8, 0x618, 0xC18, 0xC18, 0x618, 0x3F8, 0x018, 0x018, 0x018}, // shifted
    // r (114)
	{0x000, 0x000, 0x000, 0x6F0, 0x718, 0x600, 0x600, 0x600, 0x600, 0x000, 0x000, 0x000}, // shifted
    // s (115)
	{0x000, 0x000, 0x000, 0x3F0, 0x618, 0x700, 0x3E0, 0x018, 0x618, 0x3F0, 0x000, 0x000},  // shifted
    // t (116)
	{0x000, 0x180, 0x180, 0x7F8, 0x180, 0x180, 0x180, 0x180, 0x078, 0x000, 0x000, 0x000}, // shifted
    // u (117)
	{0x000, 0x000, 0x000, 0xC18, 0xC18, 0xC18, 0xC18, 0xC18, 0x7F8, 0x000, 0x000, 0x000}, // shifted
    // v (118)
	{0x000, 0x000, 0x000, 0xC18, 0xC18, 0x618, 0x618, 0x330, 0x1E0, 0x000, 0x000, 0x000}, // shifted
    // w (119)
	{0x000, 0x000, 0x000, 0xC18, 0xC18, 0xD98, 0xD98, 0xFF8, 0x770, 0x770, 0x000, 0x000}, // shifted
    // x (120)
	{0x000, 0x000, 0x000, 0x618, 0x330, 0x1E0, 0x1E0, 0x330, 0x618, 0x000, 0x000, 0x000}, // shifted
    // y (121)
	{0x000, 0x000, 0x000, 0xC60, 0xC60, 0xC60, 0xC60, 0x860, 0x7E0, 0x060, 0x860, 0x7C0}, // shifted
    // z (122)
	{0x000, 0x000, 0x000, 0xFFC, 0x018, 0x030, 0x0C0, 0x180, 0xFFC, 0x000, 0x000, 0x000}, // shifted
    // { (123)
